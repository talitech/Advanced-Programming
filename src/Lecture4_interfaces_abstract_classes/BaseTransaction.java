...
public abstract class BaseTransaction implements TransactionInterface {
    ...
    public double getAmount() {
        return amount; // Because we are dealing with Value types we need not worry about what we
                       // return
    }
    ...
    public Calendar getDate() {
        // return date; // Because we are dealing with Reference types we need to
        // judiciously copy what our getters return
